...
class UserController extends Controller
{
                    ...
                    ->addColumn('action', function ($data) {
                        return ' <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end shadow">
                                    <li><a class="dropdown-item edit-user-btn" href="javascript:void(0)" data-id="'.$data->id.'"  data-bs-toggle="modal" data-bs-target="#editUserModal"><i class="bi bi-pencil-square text-primary me-2"></i> Edit User</a></li>
                                    <li><a class="dropdown-item show-btn" href="javascript:void(0)" data-id="'.$data->id.'"  data-bs-toggle="modal" data-bs-target="#showProductModal"><i class="bi bi-eye text-info me-2"></i> Show Details</a></li>
                                    <li><a class="btn dropdown-item" href="'.route('activation', $data->id).'"><i class="bi bi-lightning-charge text-warning me-2"></i> Activation</a></li>
                                    <li><a class="dropdown-item" href="'.route('resultactivation', $data->id).'"><i class="bi bi-clipboard-data text-success me-2"></i> Result Activation</a></li>
                                    <li><a class="dropdown-item change-password" href="javascript:void(0)" data-id="'.$data->id.'"><i class="bi bi-c-circle-fill text-info me-2"></i>Change Password</a></li>
                                    <li><hr class="dropdown-divider"></li>
                                    <li><form action="'.route('users.destroy',$data->id).'" method="POST">
                                        '. csrf_field().' 
                                        '.method_field('DELETE').'
                                        <button type="submit" class="dropdown-item text-danger"> <i class="bi bi-trash me-2"></i>Delete</button></form></li>
                                </ul>
                            </div>
                        ';
                    })
    ...
    public function destroy(User $user){
            // delete from userproduct table
            DB::table('userproduct')
                ->where('user_id', $user->id)
                ->delete();

            // delete from user_result_product table
