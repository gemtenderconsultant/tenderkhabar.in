        ...
        <div class="container position-relative">
          <div class="row d-flex justify-content-center">
            <div class="col-lg-12 text-center">
                <h2>Search Latest Tender Result List</h2>
                <div class="SearchBox">
                  <form action="{{ route('searchresult') }}" id="home_searchbar_new" method="get">
                    @csrf
                    <ul>
                      <li class="SlctBox">
                        <select name="searchbar">
                          <option value="Tender Results" action="{{ route('searchresult') }}">Tender Result</option>
                          <option value="Tenders" action="{{ route('searchtenders') }}">Tenders</option>
                        </select>
                      </li>
                      <li class="InputBox">
              ...
              <div class="tender_filter_main">
                ...
                <div class="card">
                  ...
                  <div class="card-body py-grid-gutter px-lg-grid-gutter">
                        ...
                        <div class="accordion-collapse collapse show" id="within-search" data-bs-parent="#within-search" style="">
                          <div class="accordion-body">
                            <div class="input-group mb-3">
                              <input type="text" class="form-control border-right-0" id="within-text" placeholder="Search" name="search">
                    ...
                    <!-- Within Search-->
                     <!-- city-->
                    <div class="accordion mb-2 city_filter" style="display: none;">
                      <div class="accordion-item ">
                        ...
                        <div class="accordion-collapse collapse show" id="city" data-bs-parent="#city">
                          <div class="accordion-body">
                            ...
                            <div class="col-12 left_city_filter search_filter_text_scroll"></div>
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="accordion-item">
                        ...
                        <div class="accordion-collapse collapse show" id="department" data-bs-parent="#department" style="">
                          <div class="accordion-body">
                            ...
                            <div class="col-12  search_filter_text_scroll dipartment-list dipartment-div"></div>
                          </div>
                        </div>
                        <!-- Department-->
                      </div>
                      ...
                      <div class="accordion-item">
                        ...
                        <div class="accordion-collapse collapse show" id="tendervalue" data-bs-parent="#tendervalue" style="">
                          <div class="accordion-body">
                            ...
                            <div class="col-12">
                              <div class="input-group mb-3">
                                <input type="text" id="txtminprice" name="txtminprice" placeholder="0.00 rs." min="1" readonly="" class="form-control filtertxtprice" value="" autocomplete="off">
                                <input type="text" id="txtmaxprice" name="txtmaxprice" placeholder="0.00 rs." max="1000000" readonly="" class="form-control filtertxtprice" value="" autocomplete="off">
                              </div>
                            </div>
                            <div class="col-12">
                    ...
                    <div class="accordion mb-2">
                      <div class="accordion-item">
                        <h3 class="accordion-header"><a class="accordion-button" href="#closeddate" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="closeddate">Closed Date</a></h3>
                        <div class="accordion-collapse collapse show" id="closeddate" data-bs-parent="#closeddate" style="">
                          <div class="accordion-body">
                            <div class="col-12">
                              <div class="form-group">
                                <div id="reportrange" class="pull-right" style="background: #fff; cursor: pointer; padding: 5px 10px; border: 1px solid #ccc; width: 100%;font-size: 14px;">
              ...
              <div class="row">
                ...
                <div class="col-sm-2 col-6">
                  <select id="tender_check_status" class="form-control pull-right">
                    <option value="live">All Result</option>
                ...
                <div class="col-sm-3 col-6">
                  <select id="sortfilter" class="form-control pull-right">
                    ...
                    <option class="sortfilter" value="">Relevance</option>
                    <option class="sortfilter" value="hl">Awarded Value: High to Low</option>
                    <option class="sortfilter" value="lh">
                        Awarded Value: Low to High
                    </option>
                    <option class="sortfilter" value="ad">AOC Date: Asc to Desc
                    </option>
                    <option class="sortfilter" value="da">AOC Date: Desc to Asc
                    </option>
                  </select>
                </div>
              </div>
                    ...
                    <div class="card mb-2">
                      <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                          ...
                          <p class="view_link">
                              <a class="btn btn-sm btn-default btn-hover-bg me-1" href="{{ route('tenderresultview',$val->id) }}" title="View Tender" target="_blank"><i class="fa fa-eye"></i></a>
                             
                              <a class="btn btn-sm btn-default btn-hover-bg me-1" href="{{ route('tenderresultview',$val->id) }}" title="Download Document" target="_blank"><i class="fa fa-download"></i></a>

                              <a href="{{ route('tenderresultview', $val->id) }}" target="_blank" class="btn btn-sm btn-default btn-hover-bg me-1" title="tenderresultview"><i class="fa-solid fa-envelope"></i></a>
                          </p>
                        </div>
                        <a class="stretched-link" href="{{ route('tenderresultview',$val->id) }}" target="_blank"></a>
                      </div>
                    </div>
                  </div>
                  @endforeach
