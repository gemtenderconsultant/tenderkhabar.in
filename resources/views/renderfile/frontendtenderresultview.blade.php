        ...
        <div class="card mb-2">
          <div class="card-body">
            ...
            <div class="d-flex justify-content-between align-items-center">
              ...
              <p class="view_link">
                <a class="btn btn-sm btn-default btn-hover-bg me-1" href="{{ route('tenderresultview', $val->id) }}" title="tenderresultview" target="_blank"><i class="fa-solid fa-eye"></i></a>
                
                <a class="btn btn-sm btn-default btn-hover-bg me-1" href="{{ route('tenderresultview', $val->id) }}" title="Download Document" target="_blank"><i class="fa-solid fa-download"></i></a>
