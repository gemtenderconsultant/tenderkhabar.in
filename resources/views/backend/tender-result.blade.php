...
.ContentBoxFilterWrapDrop {overflow-y: auto;overflow-x: hidden;max-height: 230px;}
...
<main id="main">
  ...
  <section class="main-section pt-2">
                      ...
                      <div class="ContentAccordians">
                        <div id="flush-collapse_{{ $tfval['id'] }}" class="accordion-collapse collapse" aria-labelledby="flush-heading1_{{ $tfval['id'] }}" data-bs-parent="#accordionFlushExample">
                          <div class="accordion-body" id="collapse_{{ $tfval['id'] }}"> @if($tfval['filter_name'] != "My Preference") <div class="TopBoxMyFilter delete_filter_main">
                            ...
                            @if(isset($tfval['city']) && $tfval['city'] != "") @php $mycity = explode(',',$tfval['city']); @endphp <div class="CheckBoxSelectedValue">
                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" id="txtminprice" name="min_amount" value="{{ (isset($tenderfilters) && $tfval['Min_Amount'] != '') ? $tfval['Min_Amount'] : '' }}" placeholder="Enter Or Select Amount" required="">
                    </div>
                  </div>
                  <div class="col-md-6">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" id="txtmaxprice" name="max_amount" value="{{ (isset($tenderfilters) && $tfval['Max_Amount'] != '') ? $tfval['Max_Amount'] : '' }}" placeholder="Enter Or Select Amount" required="">
                    </div>
                  </div>
                </div>
                <div class="row mt-2">
              ...
              <div class="dropdown-menu open_dropdown dropdown_with_search p-3 dropdown_with_search" aria-labelledby="dp-more-filter">
                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                    <div class="card bg-light my-2">
                      <div class="card-body p-2">
                        <label class="mb-2">GCID Search</label>
                        <div class="input-group input-group-sm">
                          <input type="text" class="form-control clearallinput" id="Filters_ntid" placeholder="Search For GCID i.e : 26974461, 26974160" autocomplete="off">
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="card bg-light my-2">
                      <div class="card-body p-2">
                        <label class="mb-2">Portal Search</label>
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <div class="col-12 bg-secondary p-2 mt-2 rounded">
            <ul id="pills-tab-custom" class="nav nav-pills  nav-pills-custom pb-0 justify-content-end" id="pills-tab-custom" role="tablist">
              ...
              <li class="BtnSearch nav-item mt-0">
                <a class="nav-link tablinksfilter {{ ($selecttype == 'live') ? 'active' : ''}}" href="javascript:void(0)" data="live">Live <span class="box_number1"></span>
                </a>
              </li>
              <li class="BtnSearch nav-item mt-0">
              ...
              <!-- <li class="BtnSearch nav-item mt-0">
                <a class="nav-link tablinksfilter {{ ($selecttype == 'archive') ? 'active' : ''}}" href="javascript:void(0)" data="archive">Archive <span class="box_number1"></span>
                </a>
              </li> -->
              <li class="nav-item dropdown me-2">
                  <a class="btn btn-white text-black rounded dropdown-toggle bg-white border-white" href="#" role="button" id="archive" data-bs-toggle="dropdown" aria-expanded="false" style="min-width: 150px;">---select---</a>
                  <div class="dropdown-menu open_dropdown w-auto" aria-labelledby="archive">
                    ...
                    <a class="dropdown-item" href="javascript:void(0)" data="archive2023">Archieve-2023</a>
                    <a class="dropdown-item" href="javascript:void(0)" data="archive2020">Archieve-2022</a>
                ...
                <div class="dropdown-menu p-2 w-auto">
                  ...
                  <div class="radio-tile-group">
                        ...
                        <div class="input-container">
                            ...
                            <div class="radio-tile">
                                <label for="highlow" class="radio-tile-label">Price: High to Low</label>
                            </div>
                        </div>
                        ...
                        <div class="input-container">
                            ...
                            <div class="radio-tile">
                                <label for="lowhigh" class="radio-tile-label">Price: Low to High</label>
                            </div>
                        </div>
                        ...
                        <div class="input-container">
                            ...
                            <div class="radio-tile">
                                <label for="asc-dsc" class="radio-tile-label">Closing Date: Asc to Desc</label>
                            </div>
                        </div>
                        ...
                        <div class="input-container">
                            ...
                            <div class="radio-tile">
                                <label for="closing-date" class="radio-tile-label">Closing Date: Desc to Asc</label>
                            </div>
                        </div>
                    </div>
                </div>
