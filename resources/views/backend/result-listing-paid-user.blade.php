    ...
    <nav>
      <div class="container">
        <ol>
          ...
          <li>Tender Result for {{ $data->Organisation }} - TRID : {{ $data->id }}</li>
        </ol>
      </div>
    </nav>
  </div>
                    ...
                    @endif
                      ...
                      <a class="doc_link" href="{{ $url2 }}" target="_blank"  title="Document-2">
                        <div class="d-flex justify-content-between">
                           ...
                           <span class="p-2"><span>{{ pathinfo($url2, PATHINFO_FILENAME) }}</span> <i class="fa-sharp fa-solid fa-download"></i></span>
                        </div>
                      </a>
                      @endif
                  </div>
