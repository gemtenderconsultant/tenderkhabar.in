...
@section('content')
<body class="tender-details-body">
                ...
                <div class="tender-details-hero-flex">
                    <div class="tender-details-hero-left">
                        ...
                        <div class="tender-details-location-strip">
                            <i data-lucide="map-pin" size="14"></i> {{ ($data->city != "") ? $data->city : 'Refer Documents' }},{{ ($data->state_name != "") ? $data->state_name : 'Refer Documents' }}
                        </div>
        ...
        <div class="tender-details-container">
            ...
            <div class="tender-details-card-flat">
                ...
                <div class="tender-details-overview-grid">
                    <div class="tender-details-grid-item"><span>TKID -</span><strong>{{ $data->ourrefno }}</strong></div>
                    ...
                    <div class="tender-details-grid-item"><span>Site Location -</span><strong>{{ ($data->city != "") ? $data->city : 'Refer Documents' }},{{ ($data->state_name != "") ? $data->state_name : 'Refer Documents' }}</strong></div>
            ...
            <div class="position-relative">
                ...
                <div class="tender-details-card-flat">
                    ...
                    <div class="tender-details-docs-grid">
                        ...
                        <div class="tender-details-doc-row"><span>Tender Document-{{$k + 2}} {{-- pathinfo($urlo, PATHINFO_FILENAME) --}}</span><a href="{{ $url }}">Download</a></div>
                            @endforeach
                            @endif
                    </div>
