            ...
            <div class="card p-0 mb-2">
                    <div class="card-body p-0 m-0"> 
                        <!-- <a href="javascript:void(0)" class="btn btn-primary btn-block planpurchase" data="doc" popup-year="32511649" data-bs-toggle="modal" data-bs-target="#inquirymodal">
                         ...
                         <a href="javascript:void(0)" onclick="singelpayNow('Single Tender', 149, {{ $data->ourrefno }})"  class="btn btn-primary btn-block planpurchase" data="doc" popup-year="32511649">
                            Buy Now
                        </a>
                    </div>
            </div>        
