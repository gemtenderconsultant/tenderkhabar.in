                ...
                <div class="SearchBox">
                  <form action="{{ route('searchtenders') }}" id="home_searchbar_new" method="get">
                    ...
                    <ul>
                      ...
                      <li class="InputBox">
                        <input type="text" name="searchbox" id="searchbox" placeholder="Type Keyword i.e. Road, Road Construction etc." value="{{ (isset($keyword) && $keyword !='') ? $keyword  : '' }}" autocomplete="off"  class="searchbox_input ui-autocomplete-input">
                      </li>
                      <li class="BtnBox">
              ...
              <div class="row">
                ...
                <div class="col-sm-2 col-6">
                  <select id="tender_check_status" class="form-control pull-right">
                    ...
                    <!-- <option value="archive2023">Archive-2023</option>
                    <option value="archive2022">Archive-2022</option>
                    <option value="archive2021">Archive-2021</option>
                    <option value="archive2020">Archive-2020</option> -->
                  </select>
                </div>
