        ...
        <div class="container position-relative">
          <div class="row d-flex justify-content-center">
            <div class="col-lg-12 text-center">
                ...
                <div class="SearchBox">
                  <form action="{{ route('categorysearch') }}" id="home_searchbar_new" method="get">
                    @csrf
                    <ul>
                      <li class="SlctBox">
                      ...
                      <li class="InputBox">
                        <input type="text" name="searchbox" id="searchbox" placeholder="Type Keyword i.e. Road, Road Construction etc." value="{{ (isset($category) && $category !='') ? $category  : '' }}" autocomplete="off"  class="searchbox_input ui-autocomplete-input">
                      </li>
                      <li class="BtnBox">
