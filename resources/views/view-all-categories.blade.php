...
@section('content')
    ...
    <!-- <div class="w-100 text-white"> -->
          ...
          <div class="container">
            <div class="row gy-4 d-flex justify-content-between">
              <div class="col-lg-12 order-2 order-lg-1 d-flex flex-column justify-content-center">
                ...
                <h2 style="text-align:center; padding-top: 20px; color:#1e3a8a;">All categories</h2>
                <div class="search-wrapper">
                  <form id="searchForm" action="{{ route('category') }}">
                      <input type="text" id="searchInput" name="category" value="{{ request('category') }}" placeholder="Search state.." />
        ...
        <section class="card-section" id="category-cards2">
            <div class="card-grid">
                @if($category_data->count() > 0)
                    @foreach($category_data as $key => $value)
                            <div class="card-item" onclick="window.location.href='{{ route('categoryresult', ['id' => $value->name]) }}'">
                            {{ $value->name }} Tenders
                        </div>
                    @endforeach
                @else
