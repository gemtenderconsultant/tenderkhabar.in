...
@section('content')   
    ...
    <div class="search-tender-header">
        <div class="search-tender-global-search">
            <i data-lucide="search" size="16"></i>
            <form action="{{ route('searchtenders') }}" id="home_searchbar_new" method="get">
            
            <input type="text" placeholder="Search tenders..." id="searchbox" value="{{ (isset($keyword) && $keyword !='') ? $keyword  : '' }}" autocomplete="off" class="searchbox_input ui-autocomplete-input">
            </form>
        </div>
