...
@endphp
    ...
    @section('title','Tender Information | Government & Private Tenders - All Tenders at One Place')
    @section('meta_description', 'Find comprehensive tender information for government and private projects in India. Stay updated with the latest tenders details in various sectors at TenderKhabar – your one-stop tender portal.')
    @section('meta_keywords', 'Tender Khabar')
    @section('meta_category', 'Tender Khabar')
    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-4">
          ...
          @else
            <div class="card p-0 mb-2">
                    <div class="card-body p-0 m-0"> 
                        <!-- <a href="javascript:void(0)" onclick="singelpayNow('Single Tender', 1, {{ $data->ourrefno }})"  class="btn btn-primary btn-block planpurchase" data="doc" popup-year="32511649" data-bs-toggle="modal" data-bs-target="#inquirymodal">
                            Contact to Admin
                        </a> -->
                        <a href="javascript:void(0)" onclick="singelpayNow('Single Tender', 1, {{ $data->ourrefno }})"  class="btn btn-primary btn-block planpurchase" data="doc" popup-year="32511649">
                            Contact to Admin
                        </a>
                    </div>
            </div> 
