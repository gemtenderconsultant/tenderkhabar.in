...
<div class="content-area">
    ...
    <div class="card">
        <div class="card-body">
            ...
            @endif
            <form action="{{ route('postactivation',$id) }}" method="POST">
                @csrf
                <div class="row">
                    <div class="col-md-12">
                    ...
                    <div class="col-xs-6 col-sm-4 col-md-4 col-12">
                        <div class="form-group">
                            <strong>Portal:</strong>
                            <select class="form-control" name="Userproduct[portal]" id="portal">
                                <option {{ (isset($data->portal) && $data->portal == '') ? 'selected' : '' }} value="">All</option>
                                <option {{ (isset($data->portal) && $data->portal == "GEM") ? 'selected' : '' }} value="GEM">GEM</option>
                                <option {{ (isset($data->portal) && $data->portal == "NON-GEM") ? 'selected' : '' }} value="NON-GEM">NOT GEM</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-xs-6 col-sm-4 col-md-4 col-12">
