          ...
          <td width="100%" style="text-align: left;">
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="min-width:100%;">
                <tr>
                    ...
                    <td align="right">
                        <img src="'.$logourl.'" width="100" alt="'.$fromname.'">
                    </td>
                </tr>
            </table>
...
//echo $body;die();
    ...
    $emailuserid = $u_val['u_id'];
    $emailstatus = 1; //for free 1 for paid
    $emailtype = 1; //for 0 self 1 for own
    $sql = "INSERT INTO `userinfo_result`(`user_id`, `tender_date`, `status`, `total_fresh`, `no_tender_available`,`emailtype`) VALUES ('$emailuserid','" . date('Y-m-d') . "','$emailstatus','$tender_count','$totalemail','$emailtype')";
